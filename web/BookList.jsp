            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <s:form action="searchBook" method="POST" cssClass="form-inline my-2 my-lg-0 mr-lg-2">
                            <s:textfield name = "searchString" cssClass="form-control form-control-sm" placeholder="Search for book..."></s:textfield>
                            ...
                            <tbody>
                                <s:iterator value="listBook">
                                    <tr>
                                        ...
                                        <td>   
                                            <s:url var="bookDetail" action="redirectBookDetailAdmin">
